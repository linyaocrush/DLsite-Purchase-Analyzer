...
- **时间段对比** — 选取两个时间段，对比类型偏好、制作组偏好、消费金额
...
### 交互体验
- **自定义弹窗** — 完全替代原生 alert / prompt / confirm，支持键盘导航
- **可拖拽窗口** — 图表与结果窗口支持拖拽移动和缩放
- **三语界面** — 中文 / English / 日本語 随时切换，汇率独立记忆
- **进度反馈** — 页面进度条 + 控制台分页提示
...
```
DLsite.js（单文件 IIFE，~2600 行）
│
├─ utils              日志 · 下载 · 拖拽 · DOM 清理
